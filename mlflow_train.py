        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                if best_fitness == fi:
                    ...
                    mlflow.pytorch.log_model(ema.ema, artifact_path="yolo-model", pickle_module=pickle)
                    print(
                        "\nThe model is logged at:\n%s" % os.path.join(mlflow.get_artifact_uri(), "yolo-model")
                    )
                del ckpt
        # end epoch ----------------------------------------------------------------------------------------------------
    # end training
...
if __name__ == '__main__':
    ...
    if not opt.evolve:
        ...
        with mlflow.start_run(experiment_id=4, run_name='run train yolo'):
